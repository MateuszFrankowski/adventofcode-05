...
const finalArray = instructions.map((x) => {
  ...
  const copiedRewerse = copied.split("").reverse().join("");
  console.log("copiedRewerse", copiedRewerse);
  ...
  initialCharge[putCargoNumber] = initialCharge[putCargoNumber] + copiedRewerse;
